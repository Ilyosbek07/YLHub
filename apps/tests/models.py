...
class Test(BaseModel):
    course = models.ForeignKey(Course, on_delete=models.CASCADE, verbose_name=_("Course"), related_name="course_test")
...
class QuestionContent(BaseModel):
    question = models.ForeignKey(
        Question, related_name="question_content", on_delete=models.CASCADE, verbose_name=_("Question")
    )
...
class Variant(BaseModel):
    question = models.ForeignKey(
        Question, on_delete=models.CASCADE, verbose_name=_("Question"), related_name="question_variant"
    )
...
class UserTest(BaseModel):
    user = models.ForeignKey(User, related_name="user_test", on_delete=models.CASCADE, verbose_name=_("User"))
...
class UserAnswer(BaseModel):
    user = models.ForeignKey(User, related_name="user_answer", on_delete=models.CASCADE, verbose_name=_("User"))
    question = models.ForeignKey(
        Question, on_delete=models.CASCADE, verbose_name=_("Question"), related_name="user_question_answer"
    )
    selected_variant = models.ManyToManyField(Variant, related_name="user_variant")
